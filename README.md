...
# JUCE Plugin Template, derived from [Pamplejuce](https://github.com/sudara/pamplejuce)
...
3. Replace `MyPluginProject` with the name of your project in CMakeLists.txt line 6, where the `PROJECT_NAME` variable is set.

4. Pick which formats you want built on line 9.
